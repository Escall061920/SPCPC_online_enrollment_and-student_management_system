				  ...
				  <tbody style="background-color: #098744; color: white;">
				  	...
				  	// `STATUS`, `AGE`, `NATIONALITY`, `RELIGION`, `CONTACT_NO`, `HOME_ADD`, `EMAIL`, `student_status`
						...
						foreach ($cur as $result) {
				  		...
				  		echo '<td align="center" > <a title="View Information" href="index.php?view=view&id='.$result->IDNO.'"  class="btn btn-info btn-xs" style="background-color: yellow; color: black;">View <span class="fa fa-info-circle fw-fa"></span></a>

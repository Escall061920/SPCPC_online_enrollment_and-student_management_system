 ...
 <div class="row">
   ...
   <?php if(isset($_GET['process'])): ?>
                ...
                <br>
                            ...
                            <div class="note" style="margin-top: 20px; font-size: 18px; color: #555;">
    <strong>NOTE:</strong> <strong>The backup process is only available on the 15th and 30th of each month (Kinsenas at Katapusan). and</strong>
    <br><strong> No inputs should be made during the backup process.</strong>
</div>

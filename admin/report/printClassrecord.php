...
?> 
      ...
      <div class="row">
        <div class="col-xs-12 col-md-12">
          <table class="table table-bordered" style="font-size:11px" cellspacing="0" >
          <thead style="background-color: #098744; color: white;">
            ...
            <tbody style="background-color: #098744; color: white;">
              <?php
                ...
                if(isset($_POST['INST_ID']) && isset($_POST['Subject']) && isset($_POST['SECTION'])) {
                  $section = $mydb->escape_value($_POST['SECTION']);
                  
                  $sql = "SELECT * FROM `tblinstructor` i,`tblschedule` sc,`tblstudent` s,course c 
                    WHERE i.`INST_ID`=sc.`INST_ID` 
                    AND s.SECTION='{$section}' 
                    AND s.COURSE_ID = c.COURSE_ID  
                    AND i.`INST_ID`=" .$_POST['INST_ID']. " 
                    AND CONCAT(sc.SUBJ_ID,sched_day)='".$_POST['Subject']."'";

            ...
            <tbody>
              <?php
               ...
               if(isset($_POST['submit'])){ 
                ...
                $sql = "SELECT DISTINCT c.COURSE_ID, c.COURSE_NAME, s.IDNO, st.SUBJ_ID
                FROM course c
                JOIN tblstudent s ON c.COURSE_ID = s.COURSE_ID
                JOIN studentsubjects st ON s.IDNO = st.IDNO
                WHERE st.SUBJ_ID = ".$_POST['SUBJ_ID'];

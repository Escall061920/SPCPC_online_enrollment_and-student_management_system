...
?> 
 ...
 <form class="form-horizontal span6" action="controller.php?action=edit" method="POST" onsubmit="return validatePassword()">
                    ...
                    <div class="col-md-8">
                      ...
                      <div class="col-md-8">
                        <input name="deptid" type="hidden" value="">
                         ...
                         <span id="password_error" style="color: red; display: none;">Password cannot contain special characters except period(.) and dash(-)</span>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
        ...
        function validatePassword() {
            ...
            // Regular expression to check for special characters except period and dash
            var regex = /^[A-Za-z0-9.-]*$/;

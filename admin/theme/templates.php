...
?> 
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                        Hi, <?php echo $_SESSION['ACCOUNT_NAME']; ?> <img title="profile image" width="20px" height="20px" src="<?php echo web_root.'admin/user/'.$singleuser ->USERIMAGE ?>">  
                    ...
                    <ul class="dropdown-menu dropdown-acnt">
                      ...
                      <?php if ($_SESSION['ACCOUNT_TYPE'] === 'Administrator') : ?>
    <li>
        <a href="<?php echo web_root; ?>admin/user/index.php?view=edit&id=<?php echo $_SESSION['ACCOUNT_ID']; ?>">
            <?php echo $_SESSION['ACCOUNT_NAME']; ?>
        </a>
    </li>
    <li>
        <a title="Edit" href="<?php echo web_root; ?>admin/user/index.php?view=edit&id=<?php echo $_SESSION['ACCOUNT_ID']; ?>">Edit My Profile</a>
    </li>
<?php endif; ?>
   ...
   <!-- /input-group -->
                        ...
                        <li>
                                ...
                                <li>
                                    <a href="#">Class List  <span class="fa arrow"></span></a>
                                     <ul  class="nav nav-third-level">
                                        ...
                                        <li><a href="<?php echo web_root; ?>admin/report/index.php?view=perCourse" >Students Enrolled per Course/Year and Section</a></li>
                           ...
                           <!--   <li>
                                ...
                                <li>
                                    <a href="<?php echo web_root; ?>admin/report/index.php?view=log">System History Logs</a>
                                </li>

  ...
  <section class="invoice">
      ...
      <!-- /.row -->
          ...
          <?php 
            ...
            $sched_day = isset($_POST['sched_day']) ? $_POST['sched_day'] : '';
            $semester = isset($_POST['Semester']) ? $_POST['Semester'] : '';
            
            if(!empty($sched_time) && !empty($sched_day)) {
              echo 'Time: ' . $sched_time . ' - Days: ' . $sched_day . ' || ';
            }
            if(!empty($semester)) {
          ...
          ?>
            ...
            if(!empty($sched_day)) {
              $sql .= " AND sched_day = '" . $sched_day . "'";
            }
            if(!empty($sched_time)) {
              $sql .= " AND sched_time = '" . $sched_time . "'";
            }
            if(!empty($semester)) {
              $sql .= " AND sched_semester = '" . $semester . "'";
            }
            
            $sql .= " ORDER BY sched_room ASC";

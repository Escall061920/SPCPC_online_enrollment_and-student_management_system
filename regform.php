...
$_SESSION['OR_NUMBER']    =  $_POST['OR_NUMBER']; // Added OR_NUMBER
$_SESSION['STUDENT_NUMBER'] = $_POST['STUDENT_NUMBER']; // Added STUDENT_NUMBER
...
$_SESSION['OR_NUMBER']    =  $_POST['OR_NUMBER']; // Added OR_NUMBER
$_SESSION['SECTION']      =  $_POST['SECTION']; // Added SECTION
...
if($userStud){
    ...
    if ($age < 15){
       ...
       redirect("index.php?q=enrol");
		...
		$student->OR_NUMBER     = $_SESSION['OR_NUMBER'];
		$student->STUDENT_NUMBER    = $_SESSION['STUDENT_NUMBER'];
		...
		$student->SECTION       = $_SESSION['SECTION']; // Added SECTION
		 // Added OR_NUMBER
		if ($_SESSION['ENROLLMENT_TYPE'] == 'New') {
			$student->student_status = 'New';
		} elseif ($_SESSION['ENROLLMENT_TYPE'] == 'Transferee') {
			$student->student_status = 'Transferee';
		} elseif ($_SESSION['ENROLLMENT_TYPE'] == 'Old') {
			$student->student_status = 'Old';
		} else {
			// Fallback if enrollment type doesn't match any condition
...
<tr>
    <td><label>OR Number</label></td>
    <td>
        <input class="form-control input-md" id="OR_NUMBER" name="OR_NUMBER" placeholder="OR Number" type="text" maxlength="20" value="<?php echo isset($_SESSION['OR_NUMBER']) ? $_SESSION['OR_NUMBER'] : ''; ?>" >
    </td>
    <td colspan="1"></td>
    <td><label>Student Number</label></td>
	
    <td colspan="2">
        <input class="form-control input-md" id="STUDENT_NUMBER" name="STUDENT_NUMBER" placeholder="Student Number" type="text" value="<?php echo isset($_SESSION['STUDENT_NUMBER']) ? $_SESSION['STUDENT_NUMBER'] : ''; ?>" required>
    </td>
</tr>
			<tr>
...
<td colspan="2">
    <input required="true" class="form-control input-sm" name="SECTION" placeholder="Enter Section" type="text" value="<?php echo isset($_SESSION['SECTION']) ? $_SESSION['SECTION'] : ''; ?>">
</td>
			</tr>
			<tr>
			...
			<td></td>
				<td colspan="5">	
					<button class="btn btn-success btn-lg" name="regsubmit" type="submit" style="background-color: #098744;">Submit</button>
				</td>
			</tr>
		</table>
	</div>
